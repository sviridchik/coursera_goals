...
#
# Для запуска скрипта на локальном компьютере разместите рядом файл client1.py,
...
# """
# import sys
# from client1 import Client, ClientError
#
#
# def run(host, port):
...
# #     run("127.0.0.1", 8889)
import socket
con = socket.create_connection(("127.0.0.1", 8889),15)
# print(con)
con.sendall("put palm.cpu 23.7 1150864247\n".encode())
data = con.recv(2048).decode("utf-8")
print(data)
con.sendall("put palm.cpu 23.7 1150864249\n".encode())
data = con.recv(2048).decode("utf-8")
print(data)
# con.sendall("put test_multivalue_key 10.678 1503319748\n".encode())
# data = con.recv(2048).decode("utf-8")
# print(data)
# con.sendall('get test_key\n'.encode())
# data = con.recv(2048).decode("utf-8")
# print(data)
# con.sendall('get palm.cpu\n'.encode())
# data = con.recv(2048).decode("utf-8")
# print(data)
